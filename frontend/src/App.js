...
import AdminWorkshopParticipants from "./pages/AdminWorkshopParticipants";
import AdminSubjectMaterials from "./pages/AdminSubjectMaterials";
  ...
  return (
    <Layout>
      <Routes>
        ...
        <Route path="/admin/workshops/:workshopId/deltagare" element={<AdminWorkshopParticipants />} />
        <Route path="/admin/amnesmaterial" element={<AdminSubjectMaterials />} />
        ...
        <Route path="/admin/donationer" element={<AdminDonationSettings />} />
      </Routes>
    </Layout>
  );
};
