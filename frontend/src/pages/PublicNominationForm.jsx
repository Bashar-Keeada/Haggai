...
const PublicNominationForm = () => {
  ...
  const txt = {
    sv: {
      ...
      shareToMultiple: 'Flera personer',
      shareToMultipleDesc: 'Skicka till flera samtidigt',
      inviteOne: 'En person',
      inviteOneDesc: 'Fyll i formuläret nedan',
      chooseOption: 'Välj alternativ',
    ...
    ar: {
      ...
      shareToMultiple: 'عدة أشخاص',
      shareToMultipleDesc: 'إرسال لعدة أشخاص',
      inviteOne: 'شخص واحد',
      inviteOneDesc: 'املأ النموذج أدناه',
      chooseOption: 'اختر الطريقة',
