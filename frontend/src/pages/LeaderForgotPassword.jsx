...
const LeaderForgotPassword = () => {
  ...
  const txt = {
    ...
    ar: {
      ...
      successMessage: 'تحقق من بريدك الوارد للحصول على رابط إعادة التعيين',
      errorMessage: 'تعذر إرسال البريد. حاول مرة أخرى.'
    }
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`${BACKEND_URL}/api/leaders/forgot-password`, {
        method: 'POST',
      ...
      <Card className="w-full max-w-md border-0 shadow-2xl">
        ...
        <CardContent className="p-6">
          ...
          <div className="mt-6 text-center">
            <Link to="/ledare/login" className="text-sm text-haggai hover:underline flex items-center justify-center gap-1">
...
export default LeaderForgotPassword;
