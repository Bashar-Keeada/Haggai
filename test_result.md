...
agent_communication:
  ...
  - agent: "testing"
    message: |
      ...
      **TESTED URL:** https://team-dashboard-100.preview.emergentagent.com/program/f60eb66e-3956-428d-8060-181ceeb498f8
  ...
  - agent: "testing"
    message: |
      ...
      🔗 Backend URL: https://team-dashboard-100.preview.emergentagent.com/api
  ...
  - agent: "testing"
    message: |
      ...
      • Result: Link copied is "https://team-dashboard-100.preview.emergentagent.com/nominera/undefined"
      • Expected: "https://team-dashboard-100.preview.emergentagent.com/nominera/{workshopId}"
  ...
  - agent: "testing"
    message: |
      ...
      **TESTED URL:** https://team-dashboard-100.preview.emergentagent.com/ledare/registrera/QmDoiQaNN70QCL1JkvZ0cApNG9nKYorFC1EJsmVCeNM
  ...
  - agent: "testing"
    message: |
      ...
      • **CRITICAL FIX CONFIRMED**: Nomination link displays correctly:
        * Expected: https://team-dashboard-100.preview.emergentagent.com/nominera/{workshop-id}
        * Actual: https://team-dashboard-100.preview.emergentagent.com/nominera/e72af028-aa6c-4cdd-8b98-4c360e27798a
